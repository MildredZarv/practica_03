       ...
       if(Matrícula.getText().equals("") || Nombre.getText().equals("") || Contraseña.getText().equals("")){
          ...
          JOptionPane.showMessageDialog(this, "Contraseña incorrecta", "ERROR", 0,null );
           ...
           cr.setVisible(true);  
               ...
               ea.setMatricula(Matrícula.getText());
